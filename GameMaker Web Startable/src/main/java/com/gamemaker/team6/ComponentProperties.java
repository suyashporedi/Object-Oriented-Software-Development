...
public class ComponentProperties extends JPanel {
    ...
    public static final String oneDirectionX="One direction-X"; 
    public static final String oneDirectionY="One direction-Y"; 
    public static final String noReaction ="No Reaction";
    public static final String multiDirection=  "Multi direction";
	...
	public ComponentProperties(Game game, Manager gameManager, String componentString,JFrame frame) {
        ...
        colorCombobox = new JComboBox <>(circleColor);
        ...
        String[]  soundArray= {
         ...
         soundComboBox = new JComboBox <> (soundArray);
        ...
        movementCombobox = new JComboBox <>(movement);
        ...
        directionCombobox = new JComboBox <>(direction);
        ...
        shootOptionComboBox = new JComboBox<>(shootingOptions);
        ...
        shootDirectionComboBox = new JComboBox<>(shootingDirections);
        ...
        boundaryReactionComboBox = new JComboBox<>(boundaryBehaviors);
	...
	public void setProperties() {
		...
		soundSelect = soundComboBox.getSelectedItem().toString();
    	...
    	{
    		if(directionCombobox.getSelectedItem().toString().equals(oneDirectionX))
    		{
    			component.setDy(0);
    		...
    		else if(directionCombobox.getSelectedItem().toString().equals(oneDirectionY))
    		{
    		...
    		else if(directionCombobox.getSelectedItem().toString().equals(multiDirection))
    		{
    			componentMovement = new AutomaticMovement();
    			component.setDx((int)speedSpinner.getValue());
    			component.setDy((int)speedSpinner.getValue());
    	...
    	if(movementCombobox.getSelectedItem().toString().equals("WASD"))
    	{
    		...
    		if(directionCombobox.getSelectedItem().toString().equals(oneDirectionY))
    		{
    			 componentMovement = new ManualMovement("wasd",gameManager);
        		game.addKeyListener((KeyListener) componentMovement);
        		component.setDx(0);
		...
		} else if (reactionCombobox.getSelectedItem().toString().equals(noReaction)) {
			reaction = new NoReaction();

		}
		if(!soundSelect.equals("no sound") && !soundSelect.equals(""))  {
			reaction.setSound(soundSelect);
		}
