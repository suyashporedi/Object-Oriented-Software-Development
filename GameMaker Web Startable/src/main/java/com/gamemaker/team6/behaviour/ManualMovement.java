...
public class ManualMovement implements Movement, KeyListener {
	...
	int dx;
	int dy; //Change in x and y positions of the component
	int jumpStrength;
	int jumpCounter = 0; //parameters for jumping, jumpStrength for assigning strength of a jump, jumpCounter for counting the frames while jumping 
	int positionX;
	int positionY;
	boolean isLeft; 
	boolean isRight;
